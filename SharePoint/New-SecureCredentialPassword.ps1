...
While ( -Not $passwordsMatch ) {
	...
	# Get two credentials
	$credential1 = Get-Credential -UserName $Env:USERNAME -Message "Enter your credentials a first time."
	$credential2 = Get-Credential -UserName $Env:USERNAME -Message "Enter your credentials a second time."
